...
{
    public class NotFoundParameterException : VisionNetException
    {
        /// <summary>
        ...
        protected NotFoundParameterException(SerializationInfo info, StreamingContext context): base(info, context) { }
    }
}

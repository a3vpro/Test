...
namespace VisionNet.Core.Bitwise
{
    ...
    public static partial class Bits
    {
        ...
        public const int SizeOfByteInBits = sizeof(byte) * 8;
        ...
        /// Returns <paramref name="value"/> with the <paramref name="index"/>th bit cleared
        /// </summary>
        public static byte ModifyBit(this byte value, int index, bool bitValue)
        {
            if (bitValue)
...
#pragma warning restore 0162
            ...
            return unchecked((byte)(value - (byte)(value >> 1)));
        }
...
#pragma warning restore 0162
        ...
        /// </summary>
        public static bool HasSingleOneBit(byte value) => (value & unchecked((byte)(value - 1))) == 0 && value != 0;

...
namespace VisionNet.Core.Bitwise
{
    ...
    public static partial class Bits
    {
        ...
        /// </summary>
        public const int SizeOfInt64InBits = sizeof(long) * 8;
        ...
        public const int SizeOfUInt64InBits = sizeof(ulong) * 8;

        /// <summary>
        /// The presence of this method simplifies codegen when using <see cref="ShiftLeft(short, int)"/> and similar
        /// </summary>
        public static long ShiftLeft(long value, int positions) => value << positions;

        /// <summary>
        /// The presence of this method simplifies codegen when using <see cref="ShiftLeft(short, int)"/> and similar
        /// </summary>
        [MemberFor(typeof(ulong))]
        public static ulong ShiftLeft(ulong value, int positions) => value << positions;
        ...
        /// </summary>
        public static long ShiftRight(long value, int positions) => value >> positions;

        /// <summary>
        /// The presence of this method simplifies codegen when using <see cref="ShiftRight(short, int)"/> and similar
        /// </summary>
        [MemberFor(typeof(ulong))]
        public static ulong ShiftRight(ulong value, int positions) => value >> positions;
        ...
        /// <summary>Simplifies codegen</summary>
        public static long Not(long value) => ~value;
        ...
        /// Returns <paramref name="value"/> with the <paramref name="index"/>th bit cleared
        /// </summary>
        public static long ModifyBit(this long value, int index, bool bitValue)
        {
            if (bitValue)
...
#pragma warning restore 0162
        ...
        public static sbyte ReverseBytes(sbyte value) => value;

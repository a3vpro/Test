...
namespace VisionNet.Core.Patterns
{
    ...
    public class ReverseAdapter<TSource, TDestiny> : IReverseAdapter<TSource, TDestiny>
    {
        private static Mapper _mapper = new Mapper(new MapperConfiguration(cfg => cfg.CreateMap<TDestiny, TSource>()));

...
namespace VisionNet.Core.Patterns
{
    ...
    public class BidirectionalAdapter<TSource, TDestiny> : IAdapter<TSource, TDestiny>, IReverseAdapter<TSource, TDestiny>
    {
        private static Mapper _mapper = new Mapper(new MapperConfiguration(cfg => cfg.CreateMap<TSource, TDestiny>().ReverseMap()));
        ...
        /// <param name="value">The value of type <typeparamref name="TSource"/> to convert.</param>
        /// <returns>A converted value of type <typeparamref name="TDestiny"/>.</returns>
        public static TSource ConvertFrom(TDestiny value)
        {
            return _mapper.Map<TSource>(value);
        }
        ...
        /// <param name="value">The value of type <typeparamref name="TSource"/> to convert.</param>
        /// <returns>A converted value of type <typeparamref name="TDestiny"/>.</returns>
        public TSource Convert(TDestiny value)
        {
            return _mapper.Map<TSource>(value);
        }
    }

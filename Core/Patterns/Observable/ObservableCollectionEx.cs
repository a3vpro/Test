...
namespace VisionNet.Core.Patterns
{
    ...
    public class ObservableCollectionEx<T> : ObservableCollection<T>, ICloneable
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ObservableCollectionEx{T}"/> class using the specified range of items.
        /// </summary>
        /// <param name="range">The range of items to initialize the collection with.</param>
        public ObservableCollectionEx(IEnumerable<T> range) : base(range)
        {
        }

        /// <summary>
        /// Initializes a new instance of the <see cref="ObservableCollectionEx{T}"/> class using the specified list.
        /// </summary>
        ...
        public void RemoveRange(ObservableCollectionEx<T> range)
        {
            foreach (var item in range)
            {
                Remove(item);
        ...
        /// </summary>
        /// <returns>A new <see cref="ObservableCollectionEx{T}"/> with the same elements as the current collection.</returns>
        public object Clone()
        {
